...
def main():
    ...
    out_dir = os.path.join("results", "tcfg", f"{exp_name}_{i_run}")
    ...
    # ================================================================
    # load image
    logger.log(f"open dir... path: {args.img_path}")
    # -- test --------------------------------------------------------
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        # )
        label_to = th.tensor([int(args.label_to)]).to(device) * args.batch_size
        label_from = th.tensor([int(args.label_from)]).to(device) * args.batch_size
